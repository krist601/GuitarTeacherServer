			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="sound" title="${message(code: 'sample.sound.label', default: 'Sound')}" />
					
						<g:sortableColumn property="tonality" title="${message(code: 'sample.tonality.label', default: 'Tonality')}" />
				...
				<g:each in="${sampleInstanceList}" status="i" var="sampleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: sampleInstance, field: "sound")}</td>
					
						<td>${fieldValue(bean: sampleInstance, field: "tonality")}</td>
