			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="bornDate" title="${message(code: 'usuario.bornDate.label', default: 'Born Date')}" />
					
						<g:sortableColumn property="country" title="${message(code: 'usuario.country.label', default: 'Country')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usuarioInstance.id}">${fieldValue(bean: usuarioInstance, field: "bornDate")}</g:link></td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "country")}</td>
